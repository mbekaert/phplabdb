...
--
-- PostgreSQL database: phplabdb.v2 // darwin
-- --------------------------------------------------------

ALTER TABLE ONLY darwin_users DROP CONSTRAINT darwin_users_institution;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_users;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_protocol;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_preservationmethod;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_disposition;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_bioject;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_basisofrecord;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_author;
ALTER TABLE ONLY darwin_institution DROP CONSTRAINT darwin_institution_country;
ALTER TABLE ONLY darwin_institution DROP CONSTRAINT darwin_institution_contact;
ALTER TABLE ONLY darwin_geolocation DROP CONSTRAINT darwin_geolocation_habitatcategory;
ALTER TABLE ONLY darwin_geolocation DROP CONSTRAINT darwin_geolocation_datum;
ALTER TABLE ONLY darwin_geolocation DROP CONSTRAINT darwin_geolocation_country;
ALTER TABLE ONLY darwin_geolocation DROP CONSTRAINT darwin_geolocation_continentocean;
ALTER TABLE ONLY darwin_geolocation DROP CONSTRAINT darwin_geolocation_author;
ALTER TABLE ONLY darwin_environment DROP CONSTRAINT darwin_environment_geolocation;
ALTER TABLE ONLY darwin_environment DROP CONSTRAINT darwin_environment_author;
ALTER TABLE ONLY darwin_collection DROP CONSTRAINT darwin_collection_curator;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_users;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_sex;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_lifestage;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_institution;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_identificationqualifier;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_geolocation;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_event;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_density;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_conditionelement;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_collection;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_author;
ALTER TABLE ONLY darwin_weather DROP CONSTRAINT darwin_weather_pkey;
ALTER TABLE ONLY darwin_country DROP CONSTRAINT darwin_country_unique;
ALTER TABLE ONLY darwin_country DROP CONSTRAINT darwin_country_pkey;
ALTER TABLE ONLY darwin_users DROP CONSTRAINT darwin_users_unique;
ALTER TABLE ONLY darwin_users DROP CONSTRAINT darwin_users_pkey;
ALTER TABLE ONLY darwin_sex DROP CONSTRAINT darwin_sex_pkey;
ALTER TABLE ONLY darwin_sample DROP CONSTRAINT darwin_sample_pkey;
ALTER TABLE ONLY darwin_protocol DROP CONSTRAINT darwin_protocol_pkey;
ALTER TABLE ONLY darwin_preservationmethod DROP CONSTRAINT darwin_preservationmethod_pkey;
ALTER TABLE ONLY darwin_lifestage DROP CONSTRAINT darwin_lifestage_pkey;
ALTER TABLE ONLY darwin_institution DROP CONSTRAINT darwin_institution_pkey;
ALTER TABLE ONLY darwin_identificationqualifier DROP CONSTRAINT darwin_identificationqualifier_pkey;
ALTER TABLE ONLY darwin_habitatcategory DROP CONSTRAINT darwin_habitatcategory_pkey;
ALTER TABLE ONLY darwin_geolocation DROP CONSTRAINT darwin_geolocation_pkey;
ALTER TABLE ONLY darwin_environment DROP CONSTRAINT darwin_environment_pkey;
ALTER TABLE ONLY darwin_disposition DROP CONSTRAINT darwin_disposition_pkey;
ALTER TABLE ONLY darwin_density DROP CONSTRAINT darwin_density_pkey;
ALTER TABLE ONLY darwin_datum DROP CONSTRAINT darwin_datum_pkey;
ALTER TABLE ONLY darwin_continentocean DROP CONSTRAINT darwin_continentocean_pkey;
ALTER TABLE ONLY darwin_conditionelement DROP CONSTRAINT darwin_conditionelement_pkey;
ALTER TABLE ONLY darwin_collection DROP CONSTRAINT darwin_collection_pkey;
ALTER TABLE ONLY darwin_bioject DROP CONSTRAINT darwin_bioject_pkey;
ALTER TABLE ONLY darwin_basisofrecord DROP CONSTRAINT darwin_basisofrecord_pkey;
DROP TABLE darwin_country;
DROP TABLE darwin_weather;
DROP TABLE darwin_users;
DROP TABLE darwin_sex;
DROP TABLE darwin_sample;
DROP TABLE darwin_protocol;
DROP TABLE darwin_preservationmethod;
DROP TABLE darwin_lifestage;
DROP TABLE darwin_institution;
DROP TABLE darwin_identificationqualifier;
DROP TABLE darwin_habitatcategory;
DROP TABLE darwin_geolocation;
DROP TABLE darwin_environment;
DROP TABLE darwin_disposition;
DROP TABLE darwin_density;
DROP TABLE darwin_datum;
DROP TABLE darwin_continentocean;
DROP TABLE darwin_conditionelement;
DROP TABLE darwin_collection;
DROP TABLE darwin_bioject;
DROP TABLE darwin_basisofrecord;


--
-- Name: darwin_country; Type: TABLE
--

CREATE TABLE darwin_country (
    iana character varying(2) NOT NULL,
...
--
-- Name: darwin_basisofrecord; Type: TABLE
--
...
--
-- Name: darwin_bioject; Type: TABLE
--

CREATE TABLE darwin_bioject (
    prefix integer NOT NULL,
    id integer NOT NULL,
    institutioncode character varying(32) NOT NULL,
    collectioncode character varying(32) NOT NULL,
    catalognumber character varying(32),
    observer character varying(32),
    validdistributionflag boolean DEFAULT true NOT NULL,
    informationwithheld text,
    geolocation character varying(128),
    event timestamp without time zone NOT NULL,
    scientificname character varying(128),
    taxon text,
    identificationqualifier character varying(32),
    sex character varying(32),
    lifestage character varying(32),
    reproductiveevidence text,
    density character varying(32),
    conditionelement character varying(32),
    observedsize character varying(64),
    observedweight character varying(64),
    attributes text,
    comments text,
...
--
-- Name: darwin_collection; Type: TABLE
--

CREATE TABLE darwin_collection (
    collectioncode character varying(8) NOT NULL,
    name character varying(128) NOT NULL,
    description text NOT NULL,
    curator character varying(32) NOT NULL,
    updated timestamp without time zone DEFAULT now() NOT NULL
);


--
-- Name: darwin_conditionelement; Type: TABLE
--
...
--
-- Name: darwin_continentocean; Type: TABLE
--
...
--
-- Name: darwin_density; Type: TABLE
--
...
--
-- Name: darwin_disposition; Type: TABLE
--
...
--
-- Name: darwin_environment; Type: TABLE
--

CREATE TABLE darwin_environment (
    geolocation character varying(128) NOT NULL,
    datecollected timestamp without time zone NOT NULL,
    wind character varying(128),
    visibility character varying(128),
    runwayvisualrange character varying(128),
    weather character varying(128),
    conditions character varying(128),
    skycondition character varying(128),
    temperature character varying(128),
    humidity character varying(128),
    pressure character varying(128),
    managementactivities character varying(128),
    metar text,
    comments text,
    updated timestamp without time zone DEFAULT now() NOT NULL,
    author character varying(32) NOT NULL
...
--
-- Name: darwin_geolocation; Type: TABLE
--

CREATE TABLE darwin_geolocation (
    geolocation character varying(128) NOT NULL,
    continentocean character varying(8) NOT NULL,
    islandgroup character varying(128),
    island character varying(128),
    ...
    maximumelevation integer,
    minimumdepth integer,
    maximumdepth integer,
    minimumlatitude double precision NOT NULL,
    maximumlatitude double precision,
    minimumlongitude double precision NOT NULL,
    maximumlongitude double precision,
    geodeticdatum character varying(32),
    ...
    mapping text,
    habitat text,
    habitatcategory character varying(8) NOT NULL,
    comments text,
    updated timestamp without time zone DEFAULT now() NOT NULL,
    author character varying(32) NOT NULL,
    CONSTRAINT darwin_geolocation_maxlat CHECK (((maximumlatitude >= (-90)::double precision) AND (maximumlatitude <= (90)::double precision))),
    CONSTRAINT darwin_geolocation_maxlon CHECK (((maximumlongitude >= (-180)::double precision) AND (maximumlongitude <= (180)::double precision))),
    CONSTRAINT darwin_geolocation_minlat CHECK (((minimumlatitude >= (-90)::double precision) AND (minimumlatitude <= (90)::double precision))),
    CONSTRAINT darwin_geolocation_minlon CHECK (((minimumlongitude >= (-180)::double precision) AND (minimumlongitude <= (180)::double precision)))
);


--
-- Name: darwin_habitatcategory; Type: TABLE
--
...
--
-- Name: darwin_identificationqualifier; Type: TABLE
--
...
--
-- Name: darwin_institution; Type: TABLE
--

CREATE TABLE darwin_institution (
    institutioncode character varying(8) NOT NULL,
    name character varying(128) NOT NULL,
    ...
    updated timestamp without time zone DEFAULT now() NOT NULL,
    CONSTRAINT darwin_institution_lat CHECK (((latitude >= (-90)::double precision) AND (latitude <= (90)::double precision))),
    CONSTRAINT darwin_institution_lon CHECK (((longitude >= (-180)::double precision) AND (longitude <= (180)::double precision)))
);


--
-- Name: darwin_lifestage; Type: TABLE
--
...
--
-- Name: darwin_preservationmethod; Type: TABLE
--
...
--
-- Name: darwin_protocol; Type: TABLE
--
...
--
-- Name: darwin_sample; Type: TABLE
--

CREATE TABLE darwin_sample (
    prefix integer NOT NULL,
    id integer NOT NULL,
    subcatalognumber integer DEFAULT 0 NOT NULL,
    basisofrecord character varying(32) NOT NULL,
    observer character varying(32),
    bioject_prefix integer NOT NULL,
    bioject_id integer NOT NULL,
    protocolname character varying(128),
    preservationmethod character varying(128),
    disposition character varying(128) NOT NULL,
    partname character varying(128),
    condition character varying(128),
    othercatalognumbers text,
    url text,
    relatedinformation text,
    citations text,
    stockroom character varying(32),
    stockbox character varying(32),
    stockrank character varying(32),
    attributes text,
    comments text,
    updated timestamp without time zone DEFAULT now() NOT NULL,
    author character varying(32) NOT NULL
...
--
-- Name: darwin_weather; Type: TABLE
--
...
CREATE TABLE darwin_weather (
    ...
    name character varying(64) NOT NULL,
    description character varying(64) NOT NULL,
    groups character varying(64) NOT NULL
);


--
-- Data for Name: darwin_country; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_basisofrecord; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_conditionelement; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_continentocean; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_datum; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_density; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_disposition; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_habitatcategory; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_identificationqualifier; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_lifestage; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_preservationmethod; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_protocol; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_sex; Type: TABLE DATA
--
...
--
-- Data for Name: darwin_weather; Type: TABLE DATA
--
...
--
-- Name: darwin_country_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_country
    ADD CONSTRAINT darwin_country_pkey PRIMARY KEY (iana);


--
-- Name: darwin_country_unique; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_country
    ADD CONSTRAINT darwin_country_unique UNIQUE (name);


--
-- Name: darwin_basisofrecord_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_basisofrecord
    ADD CONSTRAINT darwin_basisofrecord_pkey PRIMARY KEY (name);


--
-- Name: darwin_bioject_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_bioject
    ADD CONSTRAINT darwin_bioject_pkey PRIMARY KEY (prefix, id);


--
-- Name: darwin_collection_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_collection
    ADD CONSTRAINT darwin_collection_pkey PRIMARY KEY (collectioncode);


--
-- Name: darwin_conditionelement_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_conditionelement
    ADD CONSTRAINT darwin_conditionelement_pkey PRIMARY KEY (name);


--
-- Name: darwin_continentocean_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_continentocean
    ADD CONSTRAINT darwin_continentocean_pkey PRIMARY KEY (reference);


--
-- Name: darwin_datum_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_datum
    ADD CONSTRAINT darwin_datum_pkey UNIQUE (name);


--
-- Name: darwin_density_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_density
    ADD CONSTRAINT darwin_density_pkey PRIMARY KEY (name);


--
-- Name: darwin_disposition_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_disposition
    ADD CONSTRAINT darwin_disposition_pkey PRIMARY KEY (name);


--
-- Name: darwin_environment_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_environment
    ADD CONSTRAINT darwin_environment_pkey PRIMARY KEY (geolocation,datecollected);


--
-- Name: darwin_geolocation_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_geolocation
    ADD CONSTRAINT darwin_geolocation_pkey PRIMARY KEY (geolocation);


--
-- Name: darwin_habitatcategory_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_habitatcategory
    ADD CONSTRAINT darwin_habitatcategory_pkey PRIMARY KEY (reference);


--
-- Name: darwin_identificationqualifier_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_identificationqualifier
    ADD CONSTRAINT darwin_identificationqualifier_pkey PRIMARY KEY (name);


--
-- Name: darwin_institution_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_institution
    ADD CONSTRAINT darwin_institution_pkey PRIMARY KEY (institutioncode);


--
-- Name: darwin_lifestage_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_lifestage
    ADD CONSTRAINT darwin_lifestage_pkey PRIMARY KEY (name);


--
-- Name: darwin_preservationmethod_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_preservationmethod
    ADD CONSTRAINT darwin_preservationmethod_pkey PRIMARY KEY (name);


--
-- Name: darwin_protocol_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_protocol
    ADD CONSTRAINT darwin_protocol_pkey PRIMARY KEY (name);


--
-- Name: darwin_sample_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_sample
    ADD CONSTRAINT darwin_sample_pkey PRIMARY KEY (prefix, id);


--
-- Name: darwin_sex_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_sex
    ADD CONSTRAINT darwin_sex_pkey PRIMARY KEY (name);


--
-- Name: darwin_users_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_users
    ADD CONSTRAINT darwin_users_pkey PRIMARY KEY (username);


--
-- Name: darwin_users_unique; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_users
    ADD CONSTRAINT darwin_users_unique UNIQUE (email);


--
-- Name: darwin_weather_pkey; Type: CONSTRAINT
--

ALTER TABLE ONLY darwin_weather
    ADD CONSTRAINT darwin_weather_pkey PRIMARY KEY (reference);


--
-- Name: darwin_bioject_author; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_collection; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_conditionelement; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_density; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_event; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_geolocation; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_identificationqualifier; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_institution; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_lifestage; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_sex; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_bioject_users; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_collection_curator; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_environment_author; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_environment_geolocation; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_geolocation_author; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_geolocation_continentocean; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_geolocation_country; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_geolocation_datum; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_geolocation_habitatcategory; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_institution_contact; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_institution_country; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_author; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_basisofrecord; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_bioject; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_disposition; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_preservationmethod; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_protocol; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_sample_users; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_users_institution; Type: FK CONSTRAINT
--
...
--
-- Name: darwin_country; Type: ACL
--

GRANT ALL ON TABLE darwin_country TO www;


--
-- Name: darwin_basisofrecord; Type: ACL
--

GRANT ALL ON TABLE darwin_basisofrecord TO www;


--
-- Name: darwin_bioject; Type: ACL
--

GRANT ALL ON TABLE darwin_bioject TO www;


--
-- Name: darwin_collection; Type: ACL
--

GRANT ALL ON TABLE darwin_collection TO www;


--
-- Name: darwin_conditionelement; Type: ACL
--

GRANT ALL ON TABLE darwin_conditionelement TO www;


--
-- Name: darwin_continentocean; Type: ACL
--

GRANT ALL ON TABLE darwin_continentocean TO www;


--
-- Name: darwin_datum; Type: ACL
--

GRANT ALL ON TABLE darwin_datum TO www;


--
-- Name: darwin_density; Type: ACL
--

GRANT ALL ON TABLE darwin_density TO www;


--
-- Name: darwin_disposition; Type: ACL
--

GRANT ALL ON TABLE darwin_disposition TO www;


--
-- Name: darwin_environment; Type: ACL
--

GRANT ALL ON TABLE darwin_environment TO www;


--
-- Name: darwin_geolocation; Type: ACL
--

GRANT ALL ON TABLE darwin_geolocation TO www;


--
-- Name: darwin_habitatcategory; Type: ACL
--

GRANT ALL ON TABLE darwin_habitatcategory TO www;


--
-- Name: darwin_identificationqualifier; Type: ACL
--

GRANT ALL ON TABLE darwin_identificationqualifier TO www;


--
-- Name: darwin_institution; Type: ACL
--

GRANT ALL ON TABLE darwin_institution TO www;


--
-- Name: darwin_lifestage; Type: ACL
--

GRANT ALL ON TABLE darwin_lifestage TO www;


--
-- Name: darwin_preservationmethod; Type: ACL
--

GRANT ALL ON TABLE darwin_preservationmethod TO www;


--
-- Name: darwin_protocol; Type: ACL
--

GRANT ALL ON TABLE darwin_protocol TO www;


--
-- Name: darwin_sample; Type: ACL
--

GRANT ALL ON TABLE darwin_sample TO www;


--
-- Name: darwin_sex; Type: ACL
--

GRANT ALL ON TABLE darwin_sex TO www;


--
-- Name: darwin_users; Type: ACL
--

GRANT ALL ON TABLE darwin_users TO www;


--
-- Name: darwin_weather; Type: ACL
--

GRANT ALL ON TABLE darwin_weather TO www;
