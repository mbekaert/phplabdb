...
?>
        <li>
          ...
          <ul>
            ...
            <li>
              <?php print '<strong><a href="' . $base_url . 'admin/mods.php">' . _("Mods") . '</a></strong>'; ?> 
            </li>
          </ul>
        </li>
        <li>
...
<?php
 if (isset($mods_name)) {
  $lang=((isset($_COOKIE['lang']))?$_COOKIE['lang']:'en_US');
   ...
   print "            <tr class=\"" . (($i++%2==1)?'odd':'even') . "\">\n              <td class=\"column-1\">\n                $value\n              </td>\n              <td class=\"column-2\">\n                " . $mods_desc[$key][$lang] . "\n              </td>\n              <td class=\"column-3\">\n                " . (($mods_status[$key]==true)?('<a href="' . $base_url . $mods_dir[$key] . 'admin/">' . _("Configuration") . '</a>'):'-') . "\n              </td>\n            </tr>\n";
  };
 } else {
  print "            <tr>\n              <td colspan=\"3\">\n                <em>" . _("No mods") . "</em>\n              </td>\n            </tr>\n"; 
 };
