...
<?php
 ...
 if (!(isset($_POST['markers']))) { ?>
    ...
    //<![CDATA[
var plasmid_size='<?php print $_SESSION['plasmide_proto']['length']; ?>';
    ...
    <div id="middle-one">
      ...
      <div id="content" class="plasmid">
        <div id="page-main">      
          ...
          <h3>
            <?php print _("Map") . ' (' . $_SESSION['plasmide_proto']['name'] . ' - ' . $_SESSION['plasmide_proto']['length'] . ' ' . _("bp") . ')'; ?> 
          </h3>
<?php if (!(isset($_POST['markers']))) { ?>
          <form action="<?php print $base_url . $plugin_dir['plasmiddb']; ?>addmap.php" method="post">
            <div>
              <strong><label for="markers"><?php print _("Markers:"); ?></label></strong><br>
               <textarea name="markers" id="markers" rows="5" cols="50"><?php if (isset($_SESSION['plasmide_map'])) {print $_SESSION['plasmide_map']['markers']; }; ?></textarea><br>
            ...
            <textarea name="enzymes" id="enzymes" rows="2" cols="50"><?php if (isset($_SESSION['plasmide_map'])) {print $_SESSION['plasmide_map']['enzymes']; }; ?></textarea><br>
...
<?php } else {
 $_SESSION['plasmide_map']['markers']=trim(stripslashes($_POST['markers']));
 $_SESSION['plasmide_map']['enzymes']=trim(stripslashes($_POST['enzymes']));
 if (($_SESSION['plasmide_map']['markers']=='') && ($_SESSION['plasmide_map']['enzymes']=='')) {
  unset($_SESSION['plasmide_map']);
  print "          <p>\n            " . _("Map cleaned") . "\n          </p>\n";
 };
?>
          <p>
