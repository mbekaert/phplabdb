...
<?php };?>
          ...
          <ul>
            <li><?php print _("To add new") . ' <a href="' . $base_url . $plugin .'admin/options.php?table=selection"><strong>' . _("Selection") . '</strong></a>'; ?>.</li>
            <li><?php print _("To add new") . ' <a href="' . $base_url . $plugin .'admin/options.php?table=replication"><strong>' . _("Replication") . '</strong></a>'; ?>.</li>
            <li><?php print _("To add new") . ' <a href="' . $base_url . $plugin .'admin/options.php?table=preparation"><strong>' . _("Preparation") . '</strong></a>'; ?>.</li>
            <li><?php print _("To add new") . ' <a href="' . $base_url . $plugin .'admin/options.php?table=conditioning"><strong>' . _("Conditioning") . '</strong></a>'; ?>.</li>
          </ul>
          <h3>
            <?php print _("Search"); ?> 
          </h3>
          ...
          <form action="<?php echo $base_url . $plugin; ?>admin/search.php" method="post" onsubmit="return chkFormulaire()">
            <table summary="">
              <tr>
                <td>
                  <select name="type">
